...
#pragma surface surf Lambert vertex:disp addshadow
    ...
    void disp(inout appdata_full v, out Input o)
    {
        ...
        o.noiseComb = lerp(o.noiseComb, noiseYZ, worldNormalS.y);
        o.noiseComb = lerp(o.noiseComb, noiseXZ, worldNormalS.x);
 
        v.vertex.xyz += (v.normal *(o.noiseComb * _Height)); // displacement
 
        o.col = lerp(_CloudColor, _TColor, v.vertex.z);// gradient over vertex
    }
